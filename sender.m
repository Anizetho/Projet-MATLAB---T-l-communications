...
carfreq = (0:N-1)'*2*L*(1+roll)/Tb; % carriers frequencies
...
if M ~= 1
    ...
    for n = 1:N
        ...
        sHighFFTb(1:carfreq(n)-L*ceil((1+roll)/Tb),n) = 0;
        % - after the bandwidth
        sHighFFTb(carfreq(n)+L*floor((1+roll)/Tb)+1:end,n) = 0;
    end
