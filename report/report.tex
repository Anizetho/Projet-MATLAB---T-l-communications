...
\begin{figure}[htbp]
	...
	\resizebox{\textwidth}{5cm}{%
		\tikzsetnextfilename{mod_nofilter}
		\input{figures/mod_nofilter.tex}
	}
...
\begin{figure}[htbp]
	\centering
	\resizebox{\textwidth}{5cm}{%
		\tikzsetnextfilename{mod_nodelay}
		\input{figures/mod_nodelay.tex}
	}
...
\begin{figure}[htbp]
	\centering
	\resizebox{\textwidth}{5cm}{%
		\tikzsetnextfilename{mod_filter}
		\input{figures/mod_filter.tex}
	}
